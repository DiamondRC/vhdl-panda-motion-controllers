...
class Config:
    def __init__(self, axes=3, m=3, div=12500, hist_depth=2, g_phi=0,
...
BANNER_INI = "# AUTOGENERATED by gen_lqr_block.py -- edit the generator, not this file."
BANNER_VHD = "-- AUTOGENERATED by gen_lqr_block.py -- edit the generator, not this file."
...
def make_block_vhd(c):
    ...
    out = [BANNER_VHD,
        ...
        "        init_i : in std_logic; -- [INIT] bit_mux -> reset", ""]
    ...
    out += ["",
        "        -- [GAINS] table short: words stream to DATA, no address on the bus",
        ...
        "        -- [COMMIT] param bit + wstb: pulse swaps the staged bank (value unused)",
        "        COMMIT : in std_logic_vector(31 downto 0);",
        "        COMMIT_WSTB : in std_logic;", "",
        "        GEN : out std_logic_vector(31 downto 0); -- [GEN] read: generation tag", ""]

    for k in range(c.m):
        out.append("        u%d_o : out std_logic_vector(31 downto 0); -- [U%d] pos_out" % (k, k))

    out += ["",
        "        u_valid_o : out std_logic -- [U_VALID] bit_out, DAC latch strobe",
        "    );",
        "end entity;", "", "",
        "architecture main of lqr_block is",
        "    -- Frozen build config (this adapter *is* this shape)",
        ...
        "    -- Derived (mirror lqr_top's wr_addr_i width)",
        ...
        "    -- Gain-fill source seam (register-burst today; DMA muxes in here for tier 1)",
    ...
    out += ["", "    -- Generation tag: zero-extend (16b) -> readback reg (32b)",
        ...
        "    -- Gain-fill source: register-burst stream (tier 2/3). A DMA stream (tier 1)",
        "    -- would mux into fill_* here behind a source-select.",
        ...
        "        end if;",
        "    end process;", "",
        "    -- The controller (frozen generics; commit is the raw framework strobe)",
...
def main():
    ...
    c = Config(axes=args.axes, m=args.m, div=args.div,
